...
function renderBasketMarkup(data) {
  ...
  // console.log(countEventer(userBasket))
    ...
    uniqArrId.forEach((item) => {
      ...
      markup += `<li class="event__item"><div class="event__container"><img src=${smallestPhoto(images)} class="event__img"><div class="event__box"><span class="event__quantity">x${count}</span></div><div class="event__thumb"><p class="event__text">${name}</p><div class="location__container">
